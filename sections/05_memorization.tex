...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/random_exactly_mem-vs-prompt_len-seq-varyseqlen-gen-50-xlabel-ylabel-markers} %[height=10.75em]
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/beam_search_and_overall} %[height=10.75em]
    %\put(0,-7){(b)}
    \caption{
