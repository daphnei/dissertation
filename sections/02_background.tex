...
Finally, we report perplexity (PpL), averaged over \textit{all} the top 10 outputs for each example.
...
\begin{table*}[htbp]
  ...
  \small
    ...
    % \bottomrule
    \end{tabular}%
  \caption{A survey of datasets which have been used to train large general-purpose neural language models. \TODO{fill in}}
