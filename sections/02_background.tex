...
% Possibly rename "Early History of Text Generation"
...
\TODO{I am thinking of just deleting this section becsause it is going to take me more time than I have to spend right now to do it justice.}
...
In the early days of neural language modeling, it was common to train a separate neural language model for each generative task of interest.
...
General purpose language models intended for generative language tasks tend to be trained on massive datasets scraped from the internet, such as C4 \citep{raffel2019exploring} or The Pile \citep{pile}.
...
\paragraph{Textual Instruction Following}
