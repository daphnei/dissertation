...
My work focuses on two of these differences: (1) how subtle differences in word choices impact generated text's detectability and (2) the tendency of NLG systems to plagiarize verbatim from their training data when asked to produce novel content.
\TODO{some negative ramifications of these tendencies}

Finally, I argue that we should be using NLG systems to \textit{assist} human writers in tasks rather than trying to replace them.
...
\section{Summary of Contributions} \label{subsec:goalswork}
List of papers.
What did I contribute relative to my collaborators.
