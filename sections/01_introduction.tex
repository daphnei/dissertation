...
Another key concern with using neural language models for text generation is their ability to memorize and regurgitate significant amounts of their training data.
...
Then we conduct experiments showing how observable memorization scales with respect to the number of times a sequence occurs in the training set, the model size, and the length of conditioning prompt \TODO{citation}.
