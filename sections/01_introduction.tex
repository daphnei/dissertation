...
To this end, I argue that we should be evaluating NLG systems holistically as part of larger tools mean to \textit{assist} human writers in tasks they wish to accomplish (in addition to evaluating on isolated individual tasks).
